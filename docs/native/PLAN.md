...
| Q-SHELL-16 | UI-thread exceptions | WP-A12 | log, handle, show the generic notice (log and handle done in WP-A12: `CrashLogging`; the notice joins with `INoticeService`, WP-A16) |
...
| Q-HOME-15 | STA test harness | WP-A12 | closed (ARCHITECTURE 15.4): the in-repo helper of ARCHITECTURE 2.1 and 12.1; built in WP-A12 (`tests/ShotAI.App.Tests/Support/Sta.cs`) |
