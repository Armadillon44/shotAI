...
- **Phase 4 — Windows element-level + hardening:** napi-rs `uiautomation` addon; multi-monitor/DPI correctness; double-click debounce; capture-latency tuning; Authenticode signing.
